...
namespace bg.hd.banca.juridica.infrastructure.data.repositories
{
    internal class RecaptchaRestRepository : IRecaptchaRestRepository
    {
        ...
        public async Task<RecaptchaResponse> validarRecaptcha(RecaptchaRequest request)
        {
            ...
            {
                throw new RecaptchaException("secretKey es requerida", "secretKey es requerida - Revisar el appsettings", 2);
            }
            #endregion
            ...
            string uri = string.Format(_configuration["InfraConfig:MicroAutotizaciones:urlService"]) + "v2/recaptcha/validacion";
            ...
            else
            {
                ...
                throw new RecaptchaException("Error Aplicativo", mensajeError, code);
            }
