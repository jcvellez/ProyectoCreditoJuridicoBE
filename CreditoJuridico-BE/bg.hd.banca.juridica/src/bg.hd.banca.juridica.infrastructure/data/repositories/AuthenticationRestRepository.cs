...
{
    public class AuthenticationRestRepository : IAuthenticationRestRepository
    {
        private readonly IConfiguration _configuration;
        private static AuthenticationResponse? _authenticationMemory;
        public AuthenticationRestRepository(IConfiguration Configuration)
        {
        ...
        public async Task<string> GetAccessToken()
        {
            ...
            if (_authenticationMemory == null || (_authenticationMemory != null && _authenticationMemory.expired_token != null && _authenticationMemory.expired_token <= DateTime.Now))
            {
                ...
                string uri = string.Format("{0}{1}/oauth2/token", _configuration["AzureAdInstance"], _configuration["AzureAdTenantId"]);
